    ...
    <footer class="text-center text-lg-start  text-muted" style="background-color: #38acec;font-weight:bolder;">
      ...
      <section class="">
        <div class="container text-center text-md-start mt-5">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p class="text-light"><i class="fas fa-home me-3 text-light"></i>No.206,Vellaikannu Nagar,<br>
                <i class="fas fa-envelope me-3 " style="color: #38acec;"></i>Theni main road,<br><i class="fas fa-envelope me-3 " style="color: #38acec;"></i>Madurai-625016,India.
              </p>
              <p class="text-light">
          ...
          <div id="box">
            <div class="top">
              <h1>Ask your Question??<div class="button1"><button onclick="show()"><i class="fa fa-times"></i></button> &emsp;</div>
              </h1>
            </div>
            <div class="mid">
              <div class="chat">
            ...
            <div class="input">
              <input id="userBox" type="text" autocomplete="off" onkeydown="if (event.keyCode == 13) {talk()}" placeholder="type your questions">
      ...
      <div class="text-center p-4 text-light" style="background-color: rgba(0, 0, 0, 0.05);">
        © 2023 Copyright:
        <a class="text-reset fw-bold text-light" href="www.quantanics.in" style="text-decoration:none;">Quantanics TechServ Pvt Ltd,. All Rights Reserved.</a>
        <a class="text-center p-4 text-light" href="privacy.html" style="text-decoration:underline;font-size: small;">    Privacy Policy  </a>
        <a class="text-center p-4 text-light" href="refund.html" style="text-decoration:underline;font-size: small;">    Refund Policy </a>
        <a class="text-center p-4 text-light" href="t&c.html" style="text-decoration:underline;font-size: small;">    Terms and Conditions </a>
