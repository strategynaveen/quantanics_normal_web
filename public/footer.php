  ...
  <footer class="text-center text-lg-start  text-muted" style="background-color: #38acec;font-weight:bolder;">
    ...
    <section class="">
      <div class="container text-center text-md-start mt-5">
          ...
          <!-- Grid column -->
           ...
           <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            ...
            <p class="text-light"><i class="fas fa-home me-3 text-light"></i>No.207/49 A, VOC Nagar,<br>
              <i class="fas fa-envelope me-3 " style="color: #38acec;"></i>North Street, PP Chavadi,<br><i
        ...
        <a class="btn btn-light text-dark chat"  style="margin:auto;margin-top:0.7rem;" onclick="show()" role="button">Let's Start a convo with us!</a>
    ...
    <div class="text-center p-4 text-light" style="background-color: rgba(0, 0, 0, 0.05);">
      ...
      <a class="text-center p-4 text-light" href="t&c.html" style="text-decoration:underline;">    Terms and Conditions</a>
