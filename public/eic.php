...
<?php  require 'header.php'; ?>
    ...
    <section class="container mx-auto" >
        <img src="./servicesimg/iotserviceimages/Office Event QII copy.png" class="mx-auto img-thumbnail mt-4" style="border:none;" alt="">
    </section>

    <div class="row " style="margin-top:4rem;">
        <div class="col-lg-6">
            <img src="./eic/img1.jpg" class="img-thumbnail mx-auto" style="border:none;" alt="">
        </div>
        <div class="col-lg-6">
...
under this initiative.</p>
    ...
    technology, healthcare, energy, the environment, and more.</p>
        ...
        <div class="col-lg-6">
            <img src="./eic/img2.png" class="img-thumbnail mx-auto" style="border:none;" alt="">
        </div>
    </div>
